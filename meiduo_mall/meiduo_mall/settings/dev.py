...
# 指定自定义的用户认证后端:
AUTHENTICATION_BACKENDS = ['users.utils.UsernameMobileAuthentications']

# 设置模型类，用users子应用中的模型类替换Django工程中的默认的用户模型类
...
SECRET_KEY = 'r7z6^s3$dd(u!+p8s-!58fp5z15zu2yffx$iocqlnp#zs-m0tj'
...
CORS_ORIGIN_WHITELIST = (
    'http://192.168.159.134:8080',
    'http://192.168.159.134:8001',
...
# 发送邮件的邮箱
EMAIL_HOST_USER = 'huangoo99@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'RTGRXXAGTASXDJGN'
# 收件人看到的发件人
EMAIL_FROM = 'HOO<huangoo99@163.com>'
...
FDFS_URL = 'http://192.168.159.134:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.159.134:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
